...
const STACK = ["Go", "React", "PostgreSQL", "Docker", "Cloudflare"];

const TERMINAL_BLOCK = `$ curl https://api.malaysiamapnews.com/articles?lat=3.14&lng=101.68
{
  "articles": [
    {
      "id": "a1b2c3",
      "title": "Flood warning issued for Klang Valley",
      "source": "Malaysiakini",
      "coordinates": { "lat": 3.14, "lng": 101.68 },
      "published_at": "2024-11-01T08:30:00Z"
    }
  ],
  "total": 142
}`;
                ...
                <div className="p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-[var(--border)] flex flex-col justify-between">
                  <div>
                    ...
                    <p
                      ...
                      style={{ fontFamily: "var(--font-sans)" }}
                    >
                      A real-time map-based news aggregator for Malaysia — built
                      solo, from architecture to deployment. Production-grade
                      full-stack system handling real traffic.
                    </p>
                  ...
                  >
                    <Link
                      href="https://malaysiamapnews.com"
                      target="_blank"
